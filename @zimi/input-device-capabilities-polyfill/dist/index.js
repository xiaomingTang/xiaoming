...
;(function (global) {
  ...
  if (
    'InputDeviceCapabilities' in global ||
  ...
  function InputDeviceCapabilities(inputDeviceCapabilitiesInit) {
    Object.defineProperty(this, '__firesTouchEvents', {
      value:
        ...
        'firesTouchEvents' in inputDeviceCapabilitiesInit
          ? inputDeviceCapabilitiesInit.firesTouchEvents
          : false,
      writable: false,
      enumerable: false,
    })
  ...
  var specifiedSourceCapabilitiesName =
    '__inputDeviceCapabilitiesPolyfill_specifiedSourceCapabilities'
  ...
  var eventTypesWithNoSourceCapabilities = [
    'resize',
    'error',
    'load',
    'unload',
  ...
  Object.defineProperty(UIEvent.prototype, 'sourceCapabilities', {
    get: function () {
      ...
      var sourceCapabilities =
        Date.now() < lastTouchTime + touchTimeConstant
          ? touchDevice
          : nonTouchDevice
  ...
  function augmentEventConstructor(constructorName) {
    ...
    if (
      !('length' in global[constructorName]) ||
      global[constructorName].length < 1
    )
      return
    ...
    global[constructorName] = function (type, initDict) {
      var sourceCapabilities =
        initDict && initDict.sourceCapabilities
          ? initDict.sourceCapabilities
          : null
